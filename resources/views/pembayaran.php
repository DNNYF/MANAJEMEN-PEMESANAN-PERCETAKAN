                    ...
                    <div class="px-4 py-6 sm:px-8 sm:py-10">
                        <div class="flow-root">
                            <ul class="-my-8">
                                ...
                                <div class="mt-6 border-t border-t py-2">
                                    <p class="mt-8 text-lg font-medium">Media Cetak</p>
                                    <li class=" space-y-3 py-6 text-left sm:flex-row sm:space-x-5 sm:space-y-0">
                                        <form class="mt-5 grid gap-6">
                                            <div class="relative">
                                                ...
                                                <label class="peer-checked:border-2 peer-checked:border-gray-700 peer-checked:bg-gray-50 flex cursor-pointer select-none rounded-lg border border-gray-300 p-4" for="radio_1">
                                                    ...
                                                    <div class="ml-5">
                                                        <span class="mt-2 font-semibold">Bawa Sendiri</span>
