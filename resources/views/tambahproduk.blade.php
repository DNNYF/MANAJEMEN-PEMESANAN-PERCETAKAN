    ...
    <div class="mt-20 mx-4">
        <div class=" sm:ml-64 border border-gray-200 shadow rounded-lg">
            <div class="w-full  bg-white p-8 rounded-lg w-96">
                ...
                <form>
                    <div class="mb-4">
                        <label for="produk" class="block text-gray-600">Nama Produk</label>
                        <input type="text" id="produk" name="produk" class="w-full border border-gray-300 rounded-lg py-2 px-4" />
                    </div>
                    <div class="mb-4">
                        <label for="harga_produk" class="block text-gray-600">Harga Produk</label>
                        <input type="harga_produk" id="harga_produk" name="harga_produk" class="w-full border border-gray-300 rounded-lg py-2 px-4" />
                    </div>
                    <div class="mb-4">
                        <label for="Keterangan_produk" class="block text-gray-600">Keterangan Produk</label>
                        <input type="keterangan_produk" id="keterangan_produk" name="keterangan_produk" class="w-full border border-gray-300 rounded-lg py-2 px-4" />
                    </div>
                </form>
