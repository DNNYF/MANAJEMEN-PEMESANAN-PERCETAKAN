...
@include('layout.sidebar')
    ...
    <div class="mt-20 mx-4">
        <div class="p-4 sm:ml-64 border border-gray-200 shadow rounded-lg min-h-[300px]">
        <h2 class="text-2xl font-semibold mb-4 text-center">Daftar Pesanan</h2>
            <form>
                <div class="flex mb-2">
                    <label for="search-dropdown" class="mb-2 text-sm font-medium text-gray-900 sr-only dark:text-white">dropdown</label>
            ...
            <!-- tabel -->
            <div class="relative overflow-x-auto min-h-[300px] sm:rounded-lg">
                <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        ...
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                            ...
                            <td class="px-6 py-4">
                                <button type="button" class="!hidden focus:outline-none text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800">Selesai</button>
                                
                        <button id="dropdownDefaultButton" data-dropdown-toggle="dropdown" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" type="button">Edit Status <svg class="w-2.5 h-2.5 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
                            ...
                            <div id="dropdown" class="z-10 hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                                <ul class="py-2 text-sm text-gray-700 dark:text-gray-200" aria-labelledby="dropdownDefaultButton">
                                    <form action="{{ url('/daftarpesanan/update-status', ['id' => $d->id]) }}" method="post">
                                        @csrf
                                        <li>
                                            <button type="submit" name="status" value="Baru" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left">Baru</button>
                                        </li>
                                        <li>
                                            <button type="submit" name="status" value="Proses" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left">Proses</button>
                                        </li>
                                        <li>
                                            <button type="submit" name="status" value="Selesai" class="block px-4 py-2 hover:bg-gray-100 dark:hover:bg-gray-600 dark:hover:text-white w-full text-left">Selesai</button>
                                        </li>
                                    </form>
                                </ul>
                            </div>
